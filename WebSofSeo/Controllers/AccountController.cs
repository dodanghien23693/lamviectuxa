...
namespace WebSoftSeo.Controllers
{
    ...
    public class SystemInfo
    {
        ...
        public static ApplicationUser GetCurrentUser()
        {
            ...
            return _db.Users.Find(HttpContext.Current.User.Identity.GetUserId());
        }


        private static MultiSelectList  _listSkill;

        public static MultiSelectList MultiSelectListSkills
        {
            get
            {
                if (_listSkill == null)
                {
                    _listSkill = new MultiSelectList(_db.Skills.Select(s => new { Id = s.Id, Name = s.Name }), "Id", "Name");
                }
                return _listSkill;
            }
        }
        ...
        public static string DefaultProfileImage { 
            get{
                return "~/Content/default-avatar.png";
            } 
        }
    }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                var user = new ApplicationUser
                {
                    ...
                    ImageUrl = SystemInfo.DefaultProfileImage
                };
                ...
                if (result.Succeeded)      
                {
                    ApplicationUser createdUser = db.Users.Find(user.Id);
                    if (createdUser != null)
                    {
                        List<Skill> skills = new List<Skill>();
                        foreach (int skillId in model.Skills)
                        {
                            skills.Add(db.Skills.Find(skillId));
                        }
                        createdUser.Skills = skills;
                        db.SaveChanges();
                    }
                    ...
                    //WorkExperience workExperience = new WorkExperience() {  Description = model.WorkExperience,Datetime = DateTime.Now };
